          ...
          <div class="bg-white shadow-md rounded-lg overflow-hidden transform transition duration-300 hover:scale-105">
            ...
            <div class="flex flex-col justify-between flex-1 p-4">
                ...
                <div class="flex justify-between items-center mt-4">
                    ...
                    <button class="bg-primary text-white py-2 px-4 rounded-lg hover:bg-primary-dark transition duration-300" onclick="toggleFavorite('${provider.id}')">Add to Favourite</button>
                </div>
            </div>
        </div>
        `;
